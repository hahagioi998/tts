...
<div id="navi">
    <ul id="menu">
        ...
        <li><a href="<%=request.getContextPath()%>/view/user/user_modi_pwd.jsp" class="password_on"></a></li>
    </ul>
</div>
<!--导航区域结束-->
<div id="main">
    ...
    <form action="<%=request.getContextPath()%>/updatePwdServlet" method="post" class="main_form" id="loginForm">
        ...
        <div class="button_info clearfix">
            <input type="button" value="保存" class="btn_save"  id="goUpdatePwdServlet"/>

...
<head>
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            ...
            $("#goUpdateAdminServlet").click(function () {
                $("#loginForm").submit();
            })
...
<div id="navi">
    <ul id="menu">
        ...
        <li><a href="<%=request.getContextPath()%>/view/user/user_info.jsp" class="information_on"></a></li>
...
<div id="main">
    ...
    <form action="<%=request.getContextPath()%>/updateAdminServlet" method="post" class="main_form" id="loginForm">
        <div class="text_info clearfix"><span>管理员账号：</span></div>
        <div class="input_info"><input type="text" readonly="readonly" class="readonly" value="${admin.auname}" name="auname"/></div>
        <div class="text_info clearfix"><span>角色：</span></div>
        <div class="input_info">
            <input type="text" readonly="readonly" class="readonly width400" value="${admin.roleString}" />
        </div>
        <div class="text_info clearfix"><span>姓名：</span></div>
        <div class="input_info">
            <input type="text" value="${admin.aname}" name="aname" id="aname"/>
            <span class="required">*</span>
        </div>
        <div class="text_info clearfix"><span>电话：</span></div>
        <div class="input_info">
            <input type="text" class="width200" value="${admin.atel}" name="atel" id="atel"/>
            <div class="validate_msg_medium"></div>
        </div>
        <div class="text_info clearfix"><span>Email：</span></div>
        <div class="input_info">
            <input type="text" class="width200" value="${admin.aemail}" name="aemail" id="aemail" id="aemail"/>
        ...
        <div class="button_info clearfix">
            <input type="button" value="保存" class="btn_save"  id="goUpdateAdminServlet"/>

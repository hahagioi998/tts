...
<div id="main">
    <form action="" method="">
        ...
        <div class="search_add">
            ...
            <input type="button" value="增加" class="btn_add" onclick="location.href='<%=request.getContextPath()%>/addAdminServlet';" />
        </div>
        <!--删除和密码重置的操作提示-->
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="summary" onmouseover="showDetail(true,this);"
                               onmouseout="showDetail(false,this);">${admin.roleString}</a>
                            <!--浮动的详细信息-->

    ...
    <script type="text/javascript">
       $(function () {
           ...
           $("#imagecode").click(function () {
               ...
               $("#imagecode").attr("src","${pageContext.request.contextPath}/imageServlet?time="+time);
           });
...
<body class="index">
<div class="login_box">
    <form action="<%=request.getContextPath()%>/loginServlet" id="login" method="post">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><img src="<%=request.getContextPath()%>/imageServlet" alt="验证码" title="点击更换" id="imagecode" /></td>
                <td><span class="required"></span></td>
            </tr>
            <tr>
                <td></td>
                <td class="login_button" colspan="2">
                    <a id="goLoginServlet"><img src="<%=request.getContextPath()%>/images/login_btn.png"/></a>
                </td>
                <td><span class="required"></span></td>
            </tr>
        </table>

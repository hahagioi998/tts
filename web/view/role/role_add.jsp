...
<head>
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            ...
            $("#goSaveRoleServlet").click(function () {
                $("#loginForm").submit();
            });
...
<div id="main">
    ...
    <form action="<%=request.getContextPath()%>/saveRoleServlet" method="post" class="main_form" id="loginForm">
        ...
        <div class="button_info clearfix">
            <input type="button" value="保存" class="btn_save" id="goSaveRoleServlet" />

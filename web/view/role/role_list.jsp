...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function deleteRole(rid) {
            ...
            if(message){
                location.href='${pageContext.request.contextPath}/deleteRoleServlet?rid='+rid;
            }
        }
    </script>
    <%
...
<div id="main">
    <form action="" method="">
        ...
        <div class="search_add">
            <input type="button" value="增加" class="btn_add" onclick="location.href='<%=request.getContextPath()%>/addRoleServlet';" />
        </div>
        <!--删除的操作提示-->
        ...
        <div id="data">
            <table id="datalist">
                ...
                <tr>
                    ...
                    <td>
                        <input type="button" value="修改" class="btn_modify" onclick="location.href='<%=request.getContextPath()%>/updateRoleServlet?rid=${role.rid}&roleName=${role.rname}';"/>
